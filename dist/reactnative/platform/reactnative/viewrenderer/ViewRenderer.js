...
var ViewRenderer = /** @class */ (function (_super) {
    ...
    ViewRenderer.prototype.render = function () {
        var ViewHolder = this.props.getViewHolderForType
            ? this.props.getViewHolderForType(this.props.layoutType)
            : react_native_1.View;
        return this.props.forceNonDeterministicRendering ? (React.createElement(ViewHolder, { ref: this._setRef, onLayout: this._onLayout, style: __assign({ flexDirection: this.props.isHorizontal ? "column" : "row", left: this.props.x, position: "absolute", top: this.props.y }, this.props.styleOverrides, this.animatorStyleOverrides) }, this.renderChild())) : (React.createElement(ViewHolder, { ref: this._setRef, style: __assign({ left: this.props.x, position: "absolute", top: this.props.y, height: this.props.height, width: this.props.width }, this.props.styleOverrides, this.animatorStyleOverrides) }, this.renderChild()));
    };
